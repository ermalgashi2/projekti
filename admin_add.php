				...
				<div class="card-body">
					<div class="container-fluid">
						...
						<form method="post" action="admin_add.php" enctype="multipart/form-data">
								...
								<div class="mb-3">
									<label class="control-label">Botues</label>
									<select class="form-select rounded-0"  name="publisher" required>
										<option value="" disabled selected>Ju lutemi zgjidhni këtu</option>
										<?php 
								...
								<div class="text-center">
									...
									<button type="reset" class="btn btn-default btn-sm rounded-0 border">Anulo</button>
								</div>
						</form>
					</div>
				</div>
